...
<div class="download-container">
    ...
    <div class="series-header">
        ...
        <div class="series-info">
            <h1>Enlaces de Descarga - CITY THE ANIMATION</h1>
        ...
        <div class="episodes-grid">
            <div class="episode-card">
                ...
                <div class="episode-specs">
                    <div class="episode-spec">
                        ...
                        <div class="episode-spec-value">857 MB</div>
                    </div>
                    <div class="episode-spec">
                        <div class="episode-spec-label">DURACIÓN TOTAL</div>
                        <div class="episode-spec-value">~54 min
                      </div>
                    </div>
                </div>
                <a class="download-button" href="https://tpi.li/MMc1TY1" target="_blank">
                    <span>📥</span>
                    <span>DESCARGAR</span>
                </a>
            </div>
            ...
            <div class="episode-card">
                ...
                <div class="episode-specs">
                    <div class="episode-spec">
                        <div class="episode-spec-label">PESO</div>
                        <div class="episode-spec-value">457 MB</div>
                    </div>
                    <div class="episode-spec">
                        <div class="episode-spec-label">DURACIÓN TOTAL</div>
                ...
                <a class="download-button" href="https://tpi.li/MMc1TY3" target="_blank">
                    <span>📥</span>
                    <span>DESCARGAR</span>
                </a>
            </div>
